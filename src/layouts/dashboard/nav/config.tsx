    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Giáo viên', path: PATH_DASHBOARD.user.list },
          { title: 'Lương tối thiểu', path: PATH_DASHBOARD.user.new },
        ],
      },
      {
        title: 'Cài đặt',
        ...
        children: [
          ...
          { title: 'Khóa học', path: PATH_DASHBOARD.user.list },
          { title: 'Cấu hình quan hệ', path: PATH_DASHBOARD.user.new },
          { title: 'Cấu hình quy trình', path: PATH_DASHBOARD.user.new },
